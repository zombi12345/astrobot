...
class ProfessionalPDFGenerator:
    ...
    # Добавьте другие методы, если они нужны (create_horoscope_pdf, и т.д.)
    # Они будут работать, так как pdf_gen создаётся ниже

# Создаём глобальный экземпляр класса (ОБЯЗАТЕЛЬНО на нулевом уровне отступа)
